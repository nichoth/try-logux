...
import { Action, Meta } from 'typescript-fsa'
...
export class FaunaLogStore<T> {
     ...
     */
    async add (action:Action<T>, meta:ServerMeta):Promise<false|ServerMeta> {
     ...
     */
    async byId (id:string):Promise<[Action<T>, ServerMeta]> {
